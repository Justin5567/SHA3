...
#ifndef __VCS_IMPORT_DPI_STUB_compute_sha3_dpi
#define __VCS_IMPORT_DPI_STUB_compute_sha3_dpi
__attribute__((weak)) void compute_sha3_dpi(/* INPUT */const char* A_1, /* INPUT */int A_2, /* OUTPUT */char *A_3)
{
    static int _vcs_dpi_stub_initialized_ = 0;
    static void (*_vcs_dpi_fp_)(/* INPUT */const char* A_1, /* INPUT */int A_2, /* OUTPUT */char *A_3) = NULL;
    if (!_vcs_dpi_stub_initialized_) {
        _vcs_dpi_fp_ = (void (*)(const char* A_1, int A_2, char* A_3)) dlsym(RTLD_NEXT, "compute_sha3_dpi");
    ...
    if (_vcs_dpi_fp_) {
        ...
        vcsMsgReport1("DPI-DIFNF", fileName, lineNumber, 0, 0, "compute_sha3_dpi");
    }
}
#endif /* __VCS_IMPORT_DPI_STUB_compute_sha3_dpi */

#ifndef __VCS_IMPORT_DPI_STUB_compute_sha3_dpi_0
#define __VCS_IMPORT_DPI_STUB_compute_sha3_dpi_0
__attribute__((weak)) void compute_sha3_dpi_0(/* INPUT */const char* A_1, /* INPUT */int A_2, /* OUTPUT */char *A_3)
{
    static int _vcs_dpi_stub_initialized_ = 0;
    static void (*_vcs_dpi_fp_)(/* INPUT */const char* A_1, /* INPUT */int A_2, /* OUTPUT */char *A_3) = NULL;
    if (!_vcs_dpi_stub_initialized_) {
        _vcs_dpi_fp_ = (void (*)(const char* A_1, int A_2, char* A_3)) dlsym(RTLD_NEXT, "compute_sha3_dpi_0");
        _vcs_dpi_stub_initialized_ = 1;
    }
    if (_vcs_dpi_fp_) {
        _vcs_dpi_fp_(A_1, A_2, A_3);
        ...
        int lineNumber;
        svGetCallerInfo(&fileName, &lineNumber);
        vcsMsgReport1("DPI-DIFNF", fileName, lineNumber, 0, 0, "compute_sha3_dpi_0");
    }
}
#endif /* __VCS_IMPORT_DPI_STUB_compute_sha3_dpi_0 */
